...
export const portfolioItems: DesktopItem[] = [
  ...
  { id: 'ai', label: 'AI.exe', icon: '/img/System Information.png', component: 'ai', width: 800, height: 600, minWidth: 600, minHeight: 450, group: 'portfolio' },
...
export const utilityItems: DesktopItem[] = [
  ...
  { id: 'minesweeper', label: 'Minesweeper', icon: '/img/Minesweeper.png', component: 'minesweeper', width: 220, height: 320, minWidth: 220, minHeight: 320, group: 'utilities' },
];
